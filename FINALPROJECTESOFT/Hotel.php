...
if (isset($_POST['submit1'])) {
    ...
    $sql = "INSERT INTO hotelreservation (name,telephone,address,email,nic,room_type,check_in,check_out)
    VALUES ('$name','$telephone','$address','$email','$nic','$roomtype','$checkin','$checkout')";

    $result = mysqli_query($con, $sql);

    if ($result) {
        echo '<script> alert("Hotel Reservation details submitted ")</script>';
        // header('location:#one');
    } else {
            ...
            <div id="demo" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/Hotel/1.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">

                            <p>Interior of a Hotel Room</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="img/Hotel/2.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Hotel/3.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Hotel/4.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Hotel/5.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Hotel/6.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Hotel/7.jpeg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                ...
                <!-- <div class="carousel-item">
                    <img src="img/Hotel/8.jpg" alt="" width="1050" height="550">
                    <div class="carousel-caption">
...
<div class=" container text-center border-top border-primary  "  style="background-image:url('p1aper.jpg');">
    <form action="" method="post">
        <div class="text-center my-5 ">
            <h3>Hotel Room Reservation Form</h3>
        </div>
        <br />
        ...
        <div class="form-group row justify-content-center">
            ...
            <div class="col-lg-3">
                ...
                <select class="browser-default custom-select" name="roomtype" required>
                    <option selected value="Eco-Plus">Eco-Plus</option>
        ...
        <div class="form-group row justify-content-center">
            <label for="inputEmail3" class="col-lg-2 col-form-label">
                <h7>Credit Card No : </h7>
            </label>
            <div class="col-lg-3">

                <input type="number" class="form-control" id="inputEmail3" required>
        ...
        <div class="form-group row justify-content-center">
            ...
            <div class="form-group" id="credit_cards">
                <img src="img/card/visa.jpg" id="visa">
                <img src="img/card/mastercard.jpg" id="mastercard">
                <img src="img/card/amex.jpg" id="amex">
            </div>
            <!-- <div class="col-lg-3">
        ...
        <div class="form-group row justify-content-center my-2">
            ...
            <button type="submit" class="btn btn-primary my-2" name="submit1">Submit Details</button>
        ...
        <footer style="background-color: #dff3f5; ">
            <div class="container p-4">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <h5 class="mb-1 text-primary">We Are Open For CheckIn</h5>
