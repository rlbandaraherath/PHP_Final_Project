...
<?php
include 'conn.php';
// wedding hall reservation data submission
if (isset($_POST['submit1'])) {
    ...
    $sql = "INSERT INTO weddinghallreservation (name,telephone,address,email,nic_no,hall_name,date,food_package)
    VALUES ('$name','$telephone','$address','$email','$nic','$hallname','$date','$foodpackage')";
            ...
            <div id="demo" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/Weddinghall/1.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">

                            <p>Main entrance of a wedding hall</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="img/Weddinghall/2.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Weddinghall/3.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">

                            <p>Interior of a wedding Hall</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="img/Weddinghall/4.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Weddinghall/5.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Weddinghall/6.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Weddinghall/7.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Weddinghall/8.webp" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Weddinghall/9.jpeg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
    ...
    <div class="row   my-5 justify-content-center align-items-center ">
        <div class="col-lg-3  ">
            ...
            <div class="product-image ">
                    ...
                    <img src="img/Foodmenu/fm1.jpg" alt="Product Image" height="200" width="300">
            

            </div>
            <div class="title row justify-content-center my-2">
                    <h5>Pearl</h5>
        ...
        <div class="col-lg-3  ">
            ...
            <div class="product-image ">
                    ...
                    <img src="img/Foodmenu/fm2.jpg" alt="Product Image" height="200" width="300">
        ...
        <div class="col-lg-3  ">
            ...
            <div class="product-image ">
                    ...
                    <img src="img/Foodmenu/fm3.jpg" alt="Product Image" height="200" width="300">
        ...
        <div class="col-lg-3  ">
            ...
            <div class="product-image ">
                    ...
                    <img src="img/Foodmenu/fm4.jpg" alt="Product Image" height="200" width="300">
            ...
            <div class="price row justify-content-center">RS 4000
            </div>
        </div>
...
<!-- Food menu display end -->

<!-- wedding hall reservation -->
<div class=" container text-center border-top border-primary  "  style="background-image:url('w.jpg');">
    <form method="POST" action="">
        <div class="text-center my-5 ">
            <h3>Wedding Hall Reservation Form</h3>
        </div>
        <br />
        ...
        <div class="form-group row justify-content-center">
            ...
            <div class="col-lg-3">
                ...
                <select class="browser-default custom-select" name="hallname" required>
                    <option selected> Hansagiri</option>
                    <option >Amaya</option>
                    <option >Kalpana</option>
                    <option >Nelum</option>
                </select>
        ...
        <div class="form-group row justify-content-center">
            ...
            <div class="col-lg-3">
                ...
                <select class="browser-default custom-select" name="foodpackage" required>
        ...
        <div class="form-group row justify-content-center my-5">
            ...
            <button type="submit" class="btn btn-primary my-5" name="submit1">Request Reservation</button>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="mb-1">
                            <a href="Restaurant.php" style="color: #0b0979;">Oder Food Online</a>
                        </li>
                        <li>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <h5 class="mb-1 text-primary">We Are Open For Reservation</h5>
                    <table class="table text-primary" style="border-color: rgb(7, 5, 122);">
                        <tbody>
                            ...
                            <tr>
                                <td colspan="2">Reserve Online At Any Time
                                </td>
                            </tr>
                        </tbody>
                    </table>
