...
<?php
include 'conn.php';
// catering reservation data submission
if (isset($_POST['submit2'])) {
    ...
    $sql = "INSERT INTO cateringreservation (name,telephone,address,email,nic,no_of_participants,date,selected_package)
    VALUES ('$name','$telephone','$address','$email','$nic','$noofparticipants','$date','$selectedpackage')";
            ...
            <div id="demo" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/Catering/1.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">

                            <p>Available Buffet Sets</p>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="img/Catering/2.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Catering/3.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Catering/4.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Catering/5.jpeg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Catering/6.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Catering/7.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Catering/8.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
    ...
    <div class="row   my-5 justify-content-center align-items-center ">
        <div class="col-lg-3  ">
            ...
            <div class="product-image ">
                    ...
                    <img src="img/Catfoodmenu/1.jpg" alt="Product Image" height="200" width="300">
        ...
        <div class="col-lg-3  ">
            ...
            <div class="product-image ">
                    ...
                    <img src="img/Catfoodmenu/3.jpg" alt="Product Image" height="200" width="300">
            ...
            <div class="price row justify-content-center">RS 850
            </div>
        </div>
        <div class="col-lg-3  ">
            ...
            <div class="product-image ">
                    ...
                    <img src="img/Catfoodmenu/4.jpg" alt="Product Image" height="200" width="300">
        ...
        <div class="col-lg-3  ">
            ...
            <div class="product-image ">
                    ...
                    <img src="img/Catfoodmenu/5.jpg" alt="Product Image" height="200" width="300">
...
<!-- catering service  reservation -->
<div class=" container text-center border-top border-primary  "  style="background-image:url('paper.jpg');">
    <form action="" method="POST">
        <div class="text-center my-5 ">
            <h3>Catering Service Reservation Form</h3>
        </div>
        <br />
        ...
        <div class="form-group row justify-content-center">
            ...
            <div class="col-lg-2">
                <h7>No of participants : </h7>
                <!-- <input type="text" class="form-control" id="inputEmail3"> -->

            </div>
            <div class="col-lg-3">

                <select class="browser-default custom-select" name="noofparticipants" required>
                    <option selected>Up to 100</option>
        ...
        <div class="form-group row justify-content-center">
            ...
            <div class="col-lg-2">
                <h7>Selected Package : </h7>
                <!-- <input type="text" class="form-control" id="inputEmail3"> -->

            </div>
            <div class="col-lg-3">

                <select class="browser-default custom-select" name="selectedpackage" required>
                    <option selected>Eco-Super</option>
...
<!-- catering service reservation  end -->
