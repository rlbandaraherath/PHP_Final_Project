...
<?php
include 'conn.php';
// bar  reservation data submission
if (isset($_POST['submit1'])) {
    ...
    $sql = "INSERT INTO barreservation (name,telephone,address,email,nic,no_of_tables,date,request)
    VALUES ('$name','$telephone','$address','$email','$nic','$nooftables','$date','$request')";
            ...
            <div id="demo" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/Bar/1.webp" alt="" width="1050" height="550">
                    ...
                    <div class="carousel-item">
                        <img src="img/Bar/2.webp" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Bar/3.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Bar/4.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                        <img src="img/Bar/5.jpg" alt="" width="1050" height="550">
                        <div class="carousel-caption">
...
<div class="title  row justify-content-center  border-top border-primary py-5 my-5">
    <div class="col-lg-4">
        <h3>Available Brands in Our Stores</h3>
    </div>
</div>
    ...
    <div class="row   my-5 justify-content-center align-items-center ">
        ...
        <div class="col-lg-2  ">
            ...
            <div class="product-image ">
                ...
                <img src="img/Bar/br1.png" alt="Product Image" height="150" width="150">
        ...
        <div class="col-lg-2  ">
            ...
            <div class="product-image ">
                ...
                <img src="img/Bar/br2.png" alt="Product Image" height="150" width="150">
        ...
        <div class="col-lg-2  ">
            ...
            <div class="product-image ">
                ...
                <img src="img/Bar/br3.png" alt="Product Image" height="150" width="150">
        ...
        <div class="col-lg-2  ">
            ...
            <div class="product-image ">
                ...
                <img src="img/Bar/br4.jpg" alt="Product Image" height="150" width="150">
        ...
        <div class="col-lg-2  ">
            ...
            <div class="product-image ">
                ...
                <img src="img/Bar/br5.jpg" alt="Product Image" height="150" width="150">
        ...
        <div class="col-lg-2  ">
            ...
            <div class="product-image ">
                ...
                <img src="img/Bar/br6.png" alt="Product Image" height="150" width="150">
...
<!-- bar table  reservation start -->
<div class=" container text-center border-top border-primary  "  style="background-image:url('b.webp');">
    <form action="" method="POST">
        <div class="text-center my-5 ">
            <h3>Bar Table Reservation Form</h3>
        </div>
        <br />
        ...
        <div class="form-group row justify-content-center">
            ...
            <div class="col-lg-3">
                ...
                <select class="browser-default custom-select" name="nooftables" required>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    ...
                    <table class="table text-primary" style="border-color: rgb(7, 5, 122);">
                        <tbody>
                            ...
                            <tr>
                                <td colspan="2">Online Reservation At Any Time
                                </td>
                            </tr>
                        </tbody>
                    </table>
